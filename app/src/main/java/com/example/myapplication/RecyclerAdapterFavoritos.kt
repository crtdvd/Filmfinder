...
class RecyclerAdapterFavoritos : RecyclerView.Adapter<RecyclerAdapterFavoritos.ViewHolder>() {
    var pelis: MutableList<PelisFavoritas> = ArrayList()
    lateinit var context: Context

    fun RecyclerAdapter(pelis: MutableList<PelisFavoritas>, context: Context) {
        this.pelis = pelis
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(pelicula: PelisFavoritas, context: Context) {
